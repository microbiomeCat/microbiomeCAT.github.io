...
if(cjhurl == 'microbiomecat.gitee.io'){}
	...
	layer.confirm('检测到您使用中文但访问本站境外服务器，建议访问速度更快的 Gitee 备用站', {
		title:"等待网页加载……",
  btn: ['Gitee备用站'] ,//按钮
  shade: 0
}, function(){
...
else if(cjhurl == 'microbiomecat.gitee.io'){$(".post").prepend('<div class="post-excerpt"><div class="note-plugin success no-icon"><p><strong>提示</strong><br>检测到您正通过本站Gitee服务器进行访问，此网站为国内备用网站。<br>建议您先在此浏览，<strong>如要收藏或分享本页，请使用本站 <a href="'+"https://microbiomecat.xyz"+pthurl+'" target="_blank" rel="noopener">Github服务器</a></strong></p></div></div>');}
